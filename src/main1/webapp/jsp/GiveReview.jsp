<%@page import="in.co.movie.review.Controller1.GiveReviewCtl"%>
<%@page import="in.co.movie.review.bean1.MoviesBean"%>
<%@page import="in.co.movie.review.Utility1.ServletUtility"%>
<%@page import="in.co.movie.review.Utility1.DataUtility"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>
<%@page import="in.co.movie.review.Controller1.MRView"%>
			...
			<diV class="testimonial-heading">
				...
				<form action="<%=MRView.GIVE_REVIEW_CTL%>" method="post">
					<jsp:useBean id="bean" scope="request"
						class="in.co.movie.review.bean1.GiveReview" />
