<%@page import="in.co.movie.review.Controller1.UserCtl"%>
<%@page import="in.co.movie.review.Utility1.DataUtility"%>
<%@page import="in.co.movie.review.Controller1.RegistrationCtl"%>
<%@page import="in.co.movie.review.Utility1.ServletUtility"%>
<%@page import="in.co.movie.review.Utility1.HTMLUtility"%>
...
<jsp:useBean id="bean" scope="request"
						class="in.co.movie.review.bean1.UserBean" />
